      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <Link href="/" className="group flex items-center h-full">
            <img className="h-full" src="https://nakshjewels.com/wp-content/uploads/2022/07/logo.png"/>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-1 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-yellow-500 focus:outline-none"
              >
            ...
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-3 space-y-1">
                  <Link
                    href="/auth/login"
                    className="block py-2 px-3 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-dna-blue"
                    onClick={() => setIsOpen(false)}
                  >
                    Sign in
                  </Link>
